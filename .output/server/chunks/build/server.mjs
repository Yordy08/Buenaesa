...
const _routes = [
  ...
  },
  {
    name: "somos",
    path: "/somos",
    component: () => import('./somos.vue.mjs')
  },
  {
    name: "contac",
    path: "/contac",
    component: () => import('./contac.vue.mjs')
  },
  {
    name: "registro",
    path: "/registro",
    component: () => import('./registro.vue.mjs')
  },
  {
    name: "Notis-id",
    path: "/Notis/:id()",
...
const bootstrap__ShVgZx_0Jwiv7jW_51KlM7PZcOVhw5Eo92w2dXz24s = defineNuxtPlugin(() => {
});

const smartsupp_0O2b88RhNiYk9qJ8QkubskNgo4cvwrTSW_YEXlVJTYM = defineNuxtPlugin((nuxtApp) => {
});
...
const plugins = [
  ...
  bootstrap__ShVgZx_0Jwiv7jW_51KlM7PZcOVhw5Eo92w2dXz24s,
  smartsupp_0O2b88RhNiYk9qJ8QkubskNgo4cvwrTSW_YEXlVJTYM
];
...
export { _export_sfc as _, __nuxt_component_0 as a, useNuxtApp as b, useRuntimeConfig as c, nuxtLinkDefaults as d, navigateTo as n, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useRouter as u };
