...
const _sfc_main = {
  ...
  setup(__props) {
    ref([]);
    const noticiasPersonajes = ref([]);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_router_link = resolveComponent("router-link");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container mt-5 pt-5" }, _attrs))}><h1 class="mb-4 text-center" style="${ssrRenderStyle({ "color": "#0FA6A6" })}">Noticias de Personajes</h1><div class="d-flex flex-wrap justify-content-center"><!--[-->`);
      ssrRenderList(noticiasPersonajes.value, (noticia) => {
      ...
      _push(`<!--]--></div>`);
      if (noticiasPersonajes.value.length === 0) {
        _push(`<div class="text-center mt-5"><h4>No hay noticias de Personajes aún.</h4></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Categorias/Personajes.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Personajes.vue.mjs.map
